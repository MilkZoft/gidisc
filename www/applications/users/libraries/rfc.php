...
class RFC { 
    public $nombre, $apellidoPaterno, $apellidoMaterno, $fecha, $rfc; 
     
    public function init($nombre, $apellidoPaterno, $apellidoMaterno, $fecha) { #formato de fecha: YYYY-MM-DD 
    ...
    public function CalcularHomoclave($nombreCompleto, $fecha) {      
