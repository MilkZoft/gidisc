<?php 
	...
	if(!$edit) {
		...
		$ceo        = recoverPOST("ceo");
		$levels      = recoverPOST("levels");
		$coordinator = recoverPOST("coordinator");
		$levels_directors = recoverPOST("levels_directors");
		...
		$ceo        = recoverPOST("ceo", $userPerson["CEO"]);
		$levels     = recoverPOST("levels", $userPerson["Levels"]);
		$coordinator = recoverPOST("coordinator", $userPerson["Coordinator"]);
		$levels_directors = recoverPOST("levels_directors", $userPerson["Levels_Directors"]);
		$contact    = recoverPOST("contact", $userPerson["Contact"]);
		$action	    = "edit";
